...
public class ScrewtapeInterpreter {
  ...
  public Map<Integer, Integer> bracketMap(String program) {
    // here we use a map for our closing index and opening index
    Map<Integer, Integer> map = new HashMap<>();

    // we need to use a stack to track opening bracket positions
    ...
    for (int i = 0; i < program.length(); i++) {
      ...
      if (c == '[') {
        ...
        // get the matching opening bracket index and store closing opening in the map
  ...
  public String execute(String program) {
    // get bracket map first throws if it is unmatched
    ...
    for (int i = 0; i < program.length(); i++) {
      ...
      // move left
        ...
        if (tapePointer.prev == null) {
          ...
          // update the head when moving left
          tapeHead = newNode;
        }
      ...
      // output
        ...
        char outputChar = (char) tapePointer.value;
